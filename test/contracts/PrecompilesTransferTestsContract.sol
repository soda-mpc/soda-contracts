...
contract PrecompilesTransferTestsContract {
    ...
    AllAmountValues private allAmountValues;
    ...
    function computeAndChekTransfer16(uint8 new_a, uint8 new_b, bool res) public {
    ...
    function computeAndChekTransfer32(uint8 new_a, uint8 new_b, bool res) public {
    ...
    function computeAndChekTransfer64(uint8 new_a, uint8 new_b, bool res) public {
    ...
    function transferTest(uint8 a, uint8 b, uint8 amount) public returns (uint8, uint8, bool) {
        ...
        computeAndChekTransfer16(newA, newB, result);

        // Calculate the result with casting to 32
        computeAndChekTransfer32(newA, newB, result);

        // Calculate the result with casting to 64
        computeAndChekTransfer64(newA, newB, result);
