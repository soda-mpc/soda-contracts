...
contract PrecompilesTransferScalarTestsContract {
    ...
    AllGTCastingValues private allGTCastingValues;
    ...
    function computeAndChekTransfer16(uint8 new_a, uint8 new_b, bool res, uint8 amount) public {
    ...
    function computeAndChekTransfer32(uint8 new_a, uint8 new_b, bool res, uint8 amount) public {
    ...
    function computeAndChekTransfer64(uint8 new_a, uint8 new_b, bool res, uint8 amount) public {
    ...
    function transferTest(uint8 a, uint8 b, uint8 amount) public returns (uint8, uint8, bool) {
        ...
        computeAndChekTransfer16(new_a, new_b, res, amount);

        // Calculate the result with casting to 32
        computeAndChekTransfer32(new_a, new_b, res, amount);

        // Calculate the result with casting to 64
        computeAndChekTransfer64(new_a, new_b, res, amount);
